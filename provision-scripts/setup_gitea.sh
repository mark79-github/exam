...
# Clone the project
git clone https://github.com/shekeriev/fun-facts.git  /tmp/exam

# Modify the repository
cp /vagrant/gitea/docker-compose-dev.yml /tmp/exam/docker-compose.yml
cp /vagrant/gitea/docker-compose-deploy.yml /tmp/exam/
...
cd /tmp/exam && git push -o repo.private=false http://vagrant:vagrant@192.168.99.202:3000/vagrant/exam

# Add a Webhook
curl -X 'POST' 'http://192.168.99.202:3000/api/v1/repos/vagrant/exam/hooks' \
